...
namespace CrossXbox360 {
class LLVM_LIBRARY_VISIBILITY Assembler final : public Tool {
public:
  Assembler(const ToolChain &TC) : Tool("CrossXbox360::Assembler", "as", TC) {}
...
class LLVM_LIBRARY_VISIBILITY Linker final : public Tool {
public:
  Linker(const ToolChain &TC) : Tool("CrossXbox360::Linker", "lld-link", TC) {}
...
class LLVM_LIBRARY_VISIBILITY CrossXbox360ToolChain : public Generic_GCC {
public:
  CrossXbox360ToolChain(const Driver &D, const llvm::Triple &T,
                        const llvm::opt::ArgList &Args);
